        ...
        body: BlocConsumer<AuthBloc, AuthState>(
          listener: (context, state) {
            if(state is Authenticated){
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) =>  const Frontpage()));
            }
                    ...
                    children: [
                      Container(
                        ...
                        child: TextButton(
                          ...
                          onPressed: () {
                            BlocProvider.of<AuthBloc>(context).add(SignUpRequested(name, email, confirm));
                          },
